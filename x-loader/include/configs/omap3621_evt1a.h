...
#define CONFIG_3621EVT1A	 1    /* for specific board configuration */

#define CONFIG_2GBDDR			1
 ...
 */
// UART 1 is used as UART3 is muxed with USB and a GPIO already used for EPD screen
